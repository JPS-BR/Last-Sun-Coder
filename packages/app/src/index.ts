...
export async function wireKernelDeps(): Promise<KernelDeps> {
  const root = repoRoot();
  ...
  if (typeof openOrCreateProject !== "function") throw new Error("openOrCreateProject not found");
  if (typeof upsertFile !== "function")         throw new Error("upsertFile not found");
  if (typeof insertChunk !== "function")        throw new Error("insertChunk not found");
